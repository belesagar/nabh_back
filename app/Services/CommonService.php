...
class CommonService
{
    ...
    {
        Excel::store(new DataExportController($excel_data),
            \Config::get('constant.UPLOAD_DOCUMENT_URL') . "hospital/excel/" . $file_name);
    ...
    public function createPdf($pdf_data = [], $file_name)
    {
        ...
        $pdf = PDF::loadView('pdf_template/hospital/pdf_view', $pdf_data);
